...
public class Building {
    ...
    public String getBuiltInfo() {
    	...
    	if (builtInfo == null) {
        	...
        	boolean isBuiltBySet = ! getBuiltBy().isEmpty();
        	boolean isBuiltYearSet = getBuiltYear() != 0;

        	if ( isBuiltBySet && isBuiltYearSet) {
    			builtInfo = String.format("Built by %s in %d", getBuiltBy(), getBuiltYear());
    		}
        	else if (isBuiltBySet) {
        		builtInfo = "Built by " + getBuiltBy();
    		}
        	else if (isBuiltYearSet) {
        		builtInfo = "Built in " + getBuiltYear();
    		}
        	else {
        		builtInfo = "";
    		}
    ...
    public boolean hasBuiltInfo() {
    	return ! getBuiltInfo().isEmpty();
    }
