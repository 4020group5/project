...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig foodServiceDaoConfig;
    ...
    private final FoodServiceDao foodServiceDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        foodServiceDaoConfig = daoConfigMap.get(FoodServiceDao.class).clone();
        foodServiceDaoConfig.initIdentityScope(type);
        ...
        foodServiceDao = new FoodServiceDao(foodServiceDaoConfig, this);
        ...
        registerDao(FoodService.class, foodServiceDao);
    }
    ...
    public void clear() {
        ...
        foodServiceDaoConfig.getIdentityScope().clear();
    }
    ...
    public FoodServiceDao getFoodServiceDao() {
        return foodServiceDao;
    }
